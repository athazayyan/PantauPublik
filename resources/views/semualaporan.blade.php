<x-layout>
    ...
    <div class=" min-h-screen">
        <div class="container mx-auto mt-16 px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-white mb-6">Semua Laporan</h2>
                ...
                @foreach ($laporans as $laporan)
                    <div class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-200">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-600 mb-1"><strong>Tanggal:</strong> {{ $laporan->tanggal->format('d M Y') }}
                                @if($laporan->created_at != $laporan->updated_at)
                                    <span class="text-gray-500 italic">(updated)</span>
                                @endif
                            </p>
                            ...
                            <p class="text-sm text-gray-600 mb-1">
                                Dilaporkan oleh
                                <a href="{{ route('pelapor', $laporan->pelapor->id) }}" class="text-blue-600 hover:underline">
